...
<Meta title="Components/Card" component={Card}  decorators={[(Story) => <ApplicationProvider>{Story()}</ApplicationProvider>]}/>
...
<Canvas>
  <div style={{maxWidth: '20rem', padding: '0rem 5rem'}}>
    <Card>
      <Card.Body>
...
### Card
The Card component is the main component of the Card.
