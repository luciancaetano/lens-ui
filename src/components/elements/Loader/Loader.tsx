...
const Loader: React.FC<ILoaderProps> = ({
  ...
  const fill = getComputedStyle(document.documentElement).getPropertyValue(`--lens-ui-intents-${intent}`);
  ...
  return (
    <div
      ...
      style={{
        width: `${size}rem`, height: `${size}rem`, fill, color: fill,
      }}
    >
      ...
      {type === 'eclipse' && (
        <svg
          ...
          viewBox="0 0 100 100"
        >
          <path fill={fill} d="M10 50a40 40 0 0080 0 40 42 0 01-80 0">
            <animateTransform
              attributeName="transform"
              dur="1s"
              keyTimes="0;1"
      ...
      {type === 'spinner' && (
        <svg
          ...
          viewBox="20 20 60 60"
        >
          <rect width="6" height="12" x="47" y="24" fill={fill} rx="3" ry="6">
            <animate
